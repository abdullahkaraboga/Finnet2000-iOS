                    ...
                    VStack(spacing: 0) {
                        ...
                        VStack(spacing: 0) {
                            ...
                            StockMarketTodayView(dailyIndexInfo: data.dailyIndexInfo)
                                .padding(.horizontal, 16)
                            MostChangedStocksView(stockStatsDetail: data.stockStatsDetail)
                                .padding(.horizontal, 16)
                            MostTransactionStocksView(stockStatsDetail: data.stockStatsDetail)
                                .padding(.horizontal, 16)
...
fileprivate struct TickerGridView: View {
    let liveStocks: [String: StockData]
...
fileprivate struct LiveTickerItemView: View {
    let code: String
    let data: StockData?
