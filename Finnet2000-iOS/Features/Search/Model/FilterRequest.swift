...
// MARK: - Filter Request Body

struct FilterRequest: Encodable, Sendable {
    var currency: String = ""
...
struct RatioMinMax: Encodable, Sendable {
    let id: Int
    let minValue: Double
    let maxValue: Double
}

struct FinancialMinMax: Encodable, Sendable {
    let id: Int
    let itemTypeId: Int
    let minValue: Double
    let maxValue: Double
...
struct SheetTypeAndId: Encodable, Sendable {
    var id: Int = 0
