...
struct NewsListView: View {
    ...
    init(viewModel: NewsListViewModel = DependencyContainer.shared.makeNewsListViewModel()) {
        ...
        Group {
            if viewModel.isLoading {
                ...
                List(viewModel.items) { item in
                    NavigationLink {
                        NewsDetailMarkdownView(item: item)
                    } label: {
...
struct NewsDetailMarkdownView: View {
    let item: NewsItem
